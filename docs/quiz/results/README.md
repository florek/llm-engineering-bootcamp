...
- Najlepszy wynik: 18/20 (90%) — 06.07.2026, 07.07.2026, 08.07.2026
- Najgorszy wynik: 16/20 (80%) — 18.06.2026
- Średnia ze wszystkich prób: 17,4/20 (87%)
- Ostatnie 5 wyników: 08.07.2026 (90%), 07.07.2026 (90%), 06.07.2026 (90%), 18.06.2026 (80%), 17.06.2026 (85%)
...
4. **[API]** — 1 błąd (rola `assistant` w tablicy `messages`)
5. **Braki odpowiedzi** — 8 pytań bez odpowiedzi w czterech quizach (warto domykać quiz przed sprawdzeniem)
